...
"""autogenerated by genpy from warehouse_manager/RobotInfo.msg. Do not edit."""
import sys
...
class RobotInfo(genpy.Message):
  _md5sum = "7a59c5f1b25ddb3f59ddda2688468de4"
  _type = "warehouse_manager/RobotInfo"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """nav_msgs/Odometry[] positions
float64[] yaws
int32[] labels
...
float64 y
float64 z"""
  __slots__ = ['positions','yaws','labels']
  _slot_types = ['nav_msgs/Odometry[]','float64[]','int32[]']
